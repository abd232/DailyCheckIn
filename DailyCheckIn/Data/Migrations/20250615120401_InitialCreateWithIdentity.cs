        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Attendances_AspNetUsers_ModifiedById",
                        column: x => x.ModifiedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TotalRegularHours = table.Column<double>(type: "float", nullable: false),
                    TotalTimeOffsHours = table.Column<double>(type: "float", nullable: false),
                    TotalOverTimeHours = table.Column<double>(type: "float", nullable: false),
                    TotalSalary = table.Column<int>(type: "int", nullable: false),
                    TotalAdvances = table.Column<int>(type: "int", nullable: false),
                    RemainingSalary = table.Column<int>(type: "int", nullable: false),
                    AnnuaLeavesUsed = table.Column<int>(type: "int", nullable: false),
                    ModifiedById = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ModifiedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedById = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Payrolls_AspNetUsers_ModifiedById",
                        column: x => x.ModifiedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TimeOffStart = table.Column<TimeOnly>(type: "time", nullable: false),
                    TimeOffEnd = table.Column<TimeOnly>(type: "time", nullable: true),
                    ModifiedById = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ModifiedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedById = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TimeOffs_AspNetUsers_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_TimeOffs_AspNetUsers_ModifiedById",
                        column: x => x.ModifiedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_TimeOffs_Attendances_AttendanceDayId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Attendances_Date_UserId",
                table: "Attendances",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TimeOffs_AttendanceDayId",
                table: "TimeOffs",
                column: "AttendanceDayId");

            migrationBuilder.CreateIndex(
                name: "IX_TimeOffs_CreatedById",
                table: "TimeOffs",
                column: "CreatedById");

            migrationBuilder.CreateIndex(
                name: "IX_TimeOffs_ModifiedById",
                table: "TimeOffs",
                column: "ModifiedById");
        }
